...
resource r_customTable 'Microsoft.OperationalInsights/workspaces/tables@2022-10-01' = {
  parent:r_logAnalyticsPayGWorkspace
  name: '${logAnalyticsWorkspaceParams.customTableName}${deploymentParams.global_uniqueness}_CL'
  // tags: tags
  properties: {
    // plan: 'Basic'
    /*
...
output customTableNamePrefix string = '${logAnalyticsWorkspaceParams.customTableName}${deploymentParams.global_uniqueness}'
output customTableName string = r_customTable.name
